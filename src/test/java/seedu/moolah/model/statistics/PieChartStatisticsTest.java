...
class PieChartStatisticsTest {
    ...
    public static final List<String> MONTH_BUDGET_RESULTS = List.of("HEALTHCARE(12.50%)", "TRANSPORT(1.04%)", "TRAVEL(1.56%)",
    ...
    void pieChart_weekPeriodWithOnlyStartDate_correctOutput() {
        ...
        PieChartStatistics statistics = PieChartStatistics.run(Category.getValidCategories(), WEEK_BUDGET_START_DATE
                , null, budget);
    ...
    void pieChart_futureWeekPeriodWithOnlyStartDate_correctOutput() {
        Budget budget = TypicalMooLah.getPopulatedWeekBudget();
        PieChartStatistics statistics = PieChartStatistics.run(Category.getValidCategories(), FUTURE_WEEK_BUDGET_START_DATE
                , null, budget);
